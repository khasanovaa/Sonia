...
note_cl = [52, 48, 55, 67, 64, 60, 57, 69, 70, 58, 63, 51, 50, 65, 66, 68, 53, 72, 74, 62, 75, 36, 76, 79, 43, 31, 39, 40, 71, 45, 73, 34, 35, 38, 29, 32, 33, 41, 44, 77, 81, 37, 59, 47, 46, 82, 84, 87, 88, 100, 94, 98, 96, 86, 93, 91, 101, 80, 89, 83, 99, 42, 78, 90, 54, 56, 49, 95, 92, 30, 85, 102, 103, 108, 61, 28, 24, 105, 104, 107, 106, 97]
...
def process(s):
    ...
    decoder.load_state_dict(torch.load("decoders/decoder7", map_location='cpu'))
    ...
    fs.midi_to_audio('output.mid', 'new_song.wav')
